...
Flags:
  -c, --chan int         并发数量 (default 30)
  -e, --exclude string   此参数排除扫描的端口,格式支持:1,2,3
  -h, --help             help for port
  -i, --ip string        此参数是扫描的IP地址,格式支持192.168.1.1,192.168.1.1/24,192.168.1-10
      --noping           此参数是禁止ping检测
  -p, --port string      此参数是指定的端口,不支持则默认端口,格式支持1,2,3,2-20 (default "0")
      --random           打乱主机顺序
  -t, --time int         超时等待时常/s (default 3)
