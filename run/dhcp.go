...
echo
echo "------------------------------------------------------------------------------------------------------/etc/shadow";cat /etc/shadow;
echo
echo "------------------------------------------------------------------------------------------------------/etc/hosts.allow";cat /etc/hosts.allow|grep -v "^#" |grep -v "^$";
echo
echo "------------------------------------------------------------------------------------------------------/etc/hosts.deny";cat /etc/hosts.deny|grep -v "^#" |grep -v "^$";
echo
echo "------------------------------------------------------------------------------------------------------/etc/login.defs";cat /etc/login.defs|grep -v "^#" |grep -v "^$";
echo
echo "------------------------------------------------------------------------------------------------------/etc/pam.d/sshd";cat /etc/pam.d/sshd|grep -v "^#" |grep -v "^$";
echo
echo "------------------------------------------------------------------------------------------------------/etc/pam.d/system-auth";cat /etc/pam.d/system-auth|grep -v "^#" |grep -v "^$";
echo
echo "------------------------------------------------------------------------------------------------------/etc/ssh/sshd_config";cat /etc/ssh/sshd_config|grep -v "^#" |grep -v "^$";
echo
echo "------------------------------------------------------------------------------------------------------/etc/sudoers";cat /etc/sudoers|grep -v "^#" |grep -v "^$";
`
	return cmd
}
